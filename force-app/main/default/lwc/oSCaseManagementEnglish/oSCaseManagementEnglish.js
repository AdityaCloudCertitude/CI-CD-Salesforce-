...
import { OMNIDEF } from './oSCaseManagementEnglish_def.js';
import tmpl from './oSCaseManagementEnglish.html';
import tmpl_nds from './oSCaseManagementEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class oSCaseManagementEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
