...
import { OMNIDEF } from './oSCreateCaseEnglish_def.js';
import tmpl from './oSCreateCaseEnglish.html';
import tmpl_nds from './oSCreateCaseEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class oSCreateCaseEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
